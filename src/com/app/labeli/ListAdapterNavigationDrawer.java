...
/**
 * > @ListAdapterNavigationDrawer
 *
 * Adapter for the MainActivity's LeftDrawer
 *
...
public class ListAdapterNavigationDrawer extends BaseAdapter {
	...
	public ListAdapterNavigationDrawer(Context context,
			ArrayList<ItemNavigationDrawer> navDrawerItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ImageView imgIcon = (ImageView) convertView
				.findViewById(R.id.navigation_drawer_item_icon);
		TextView txtTitle = (TextView) convertView
				.findViewById(R.id.navigation_drawer_item_title);
