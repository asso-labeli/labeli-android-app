...
public  class Unserializer extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxe_Unserializer(haxe.Unserializer __temp_me14, java.lang.String buf)
	{
		__temp_me14.buf = buf;
		__temp_me14.length = buf.length();
		__temp_me14.pos = 0;
		__temp_me14.scache = new haxe.root.Array<java.lang.String>();
		__temp_me14.cache = new haxe.root.Array();
	...
	public static   haxe.root.Array<java.lang.Object> initCodes()
	{
		haxe.root.Array<java.lang.Object> codes = new haxe.root.Array<java.lang.Object>();
		{
			...
			{
				int i = _g1++;
				int __temp_stmt154 = 0;
				{
					java.lang.String s = haxe.Unserializer.BASE64;
					__temp_stmt154 = ( (( i < s.length() )) ? (((int) (s.charAt(i)) )) : (-1) );
				}
				
				codes.__set(__temp_stmt154, i);
			}
	...
	public   void setResolver(java.lang.Object r)
	{
		...
		{
			{
				haxe.lang.Function __temp_odecl119 = ( (( haxe.Unserializer_setResolver_127__Fun.__hx_current != null )) ? (haxe.Unserializer_setResolver_127__Fun.__hx_current) : (haxe.Unserializer_setResolver_127__Fun.__hx_current = ((haxe.Unserializer_setResolver_127__Fun) (new haxe.Unserializer_setResolver_127__Fun()) )) );
				haxe.lang.Function __temp_odecl120 = ( (( haxe.Unserializer_setResolver_128__Fun.__hx_current != null )) ? (haxe.Unserializer_setResolver_128__Fun.__hx_current) : (haxe.Unserializer_setResolver_128__Fun.__hx_current = ((haxe.Unserializer_setResolver_128__Fun) (new haxe.Unserializer_setResolver_128__Fun()) )) );
				this.resolver = new haxe.lang.DynamicObject(new haxe.root.Array<java.lang.String>(new java.lang.String[]{"resolveClass", "resolveEnum"}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{__temp_odecl119, __temp_odecl120}), new haxe.root.Array<java.lang.String>(new java.lang.String[]{}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{}));
			}
	...
	public   void unserializeObject(java.lang.Object o)
	{
		while (true)
		{
			...
			int __temp_stmt121 = 0;
			{
				int p = this.pos;
				{
					java.lang.String s = this.buf;
					__temp_stmt121 = ( (( p < s.length() )) ? (((int) (s.charAt(p)) )) : (-1) );
				}
				
			}
			
			if (( __temp_stmt121 == 103 )) 
			{
				break;
			}
	...
	public   java.lang.Object unserializeEnum(java.lang.Class<java.lang.Object> edecl, java.lang.String tag)
	{
		int __temp_stmt122 = 0;
		{
			...
			{
				java.lang.String s = this.buf;
				__temp_stmt122 = ( (( p < s.length() )) ? (((int) (s.charAt(p)) )) : (-1) );
			}
			
		}
		
		if (( __temp_stmt122 != 58 )) 
		{
	...
	{
		{
			...
			switch (_g)
			{
				...
				case 121:
				{
					...
					int __temp_stmt125 = 0;
					{
						int p3 = this.pos++;
						{
							java.lang.String s2 = this.buf;
							__temp_stmt125 = ( (( p3 < s2.length() )) ? (((int) (s2.charAt(p3)) )) : (-1) );
						}
						
					}
					
					boolean __temp_stmt124 = ( __temp_stmt125 != 58 );
					boolean __temp_boolv126 = false;
					if ( ! (__temp_stmt124) ) 
					{
						__temp_boolv126 = ( ( this.length - this.pos ) < len );
					}
					
					boolean __temp_stmt123 = ( __temp_stmt124 || __temp_boolv126 );
					if (__temp_stmt123) 
					{
				...
				case 108:
				{
					...
					do 
					{
						int __temp_stmt127 = 0;
						{
							int p5 = this.pos;
							{
								java.lang.String s5 = this.buf;
								__temp_stmt127 = ( (( p5 < s5.length() )) ? (((int) (s5.charAt(p5)) )) : (-1) );
							}
							
						}
						
						if (( __temp_stmt127 != 104 )) 
						{
					...
					do 
					{
						int __temp_stmt128 = 0;
						{
							int p6 = this.pos;
							{
								...
								__temp_stmt128 = ( (( p6 < s6.length() )) ? (((int) (s6.charAt(p6)) )) : (-1) );
							}
							
						}
						
						if (( __temp_stmt128 != 104 )) 
						{
					...
					do 
					{
						int __temp_stmt129 = 0;
						{
							int p9 = this.pos;
							{
								...
								__temp_stmt129 = ( (( p9 < s10.length() )) ? (((int) (s10.charAt(p9)) )) : (-1) );
							}
							
						}
						
						if (( __temp_stmt129 != 104 )) 
						{
				...
				case 115:
				{
					...
					int __temp_stmt132 = 0;
					{
						int p10 = this.pos++;
						{
							java.lang.String s12 = this.buf;
							__temp_stmt132 = ( (( p10 < s12.length() )) ? (((int) (s12.charAt(p10)) )) : (-1) );
						}
						
					}
					
					boolean __temp_stmt131 = ( __temp_stmt132 != 58 );
					boolean __temp_boolv133 = false;
					if ( ! (__temp_stmt131) ) 
					{
						__temp_boolv133 = ( ( this.length - this.pos ) < len1 );
					}
					
					boolean __temp_stmt130 = ( __temp_stmt131 || __temp_boolv133 );
					if (__temp_stmt130) 
					{
					...
					while (( i1 < max ))
					{
						...
						{
							int index1 = i1++;
							__temp_stmt135 = ( (( index1 < buf5.length() )) ? (((int) (buf5.charAt(index1)) )) : (-1) );
						}
						
						java.lang.Object __temp_stmt134 = codes.__get(__temp_stmt135);
						int c11 = ((int) (haxe.lang.Runtime.toInt(__temp_stmt134)) );
						int __temp_stmt137 = 0;
						{
							int index2 = i1++;
							__temp_stmt137 = ( (( index2 < buf5.length() )) ? (((int) (buf5.charAt(index2)) )) : (-1) );
						}
						
						java.lang.Object __temp_stmt136 = codes.__get(__temp_stmt137);
						int c21 = ((int) (haxe.lang.Runtime.toInt(__temp_stmt136)) );
						{
							int pos = bpos++;
							bytes.b[pos] = ((byte) (( ( c11 << 2 ) | ( c21 >> 4 ) )) );
						}
						
						int __temp_stmt139 = 0;
						{
							int index3 = i1++;
							__temp_stmt139 = ( (( index3 < buf5.length() )) ? (((int) (buf5.charAt(index3)) )) : (-1) );
						}
						
						java.lang.Object __temp_stmt138 = codes.__get(__temp_stmt139);
						int c3 = ((int) (haxe.lang.Runtime.toInt(__temp_stmt138)) );
						{
							int pos1 = bpos++;
							bytes.b[pos1] = ((byte) (( ( c21 << 4 ) | ( c3 >> 2 ) )) );
						}
						
						int __temp_stmt141 = 0;
						{
							int index4 = i1++;
							__temp_stmt141 = ( (( index4 < buf5.length() )) ? (((int) (buf5.charAt(index4)) )) : (-1) );
						}
						
						java.lang.Object __temp_stmt140 = codes.__get(__temp_stmt141);
						int c4 = ((int) (haxe.lang.Runtime.toInt(__temp_stmt140)) );
						{
							int pos2 = bpos++;
					...
					if (( rest >= 2 )) 
					{
						...
						{
							int index5 = i1++;
							__temp_stmt143 = ( (( index5 < buf5.length() )) ? (((int) (buf5.charAt(index5)) )) : (-1) );
						}
						
						java.lang.Object __temp_stmt142 = codes.__get(__temp_stmt143);
						int c12 = ((int) (haxe.lang.Runtime.toInt(__temp_stmt142)) );
						int __temp_stmt145 = 0;
						{
							int index6 = i1++;
							__temp_stmt145 = ( (( index6 < buf5.length() )) ? (((int) (buf5.charAt(index6)) )) : (-1) );
						}
						
						java.lang.Object __temp_stmt144 = codes.__get(__temp_stmt145);
						int c22 = ((int) (haxe.lang.Runtime.toInt(__temp_stmt144)) );
						{
							int pos3 = bpos++;
						...
						if (( rest == 3 )) 
						{
							int __temp_stmt147 = 0;
							{
								int index7 = i1++;
								__temp_stmt147 = ( (( index7 < buf5.length() )) ? (((int) (buf5.charAt(index7)) )) : (-1) );
							}
							
							java.lang.Object __temp_stmt146 = codes.__get(__temp_stmt147);
							int c31 = ((int) (haxe.lang.Runtime.toInt(__temp_stmt146)) );
							{
								int pos4 = bpos++;
				...
				case 67:
				{
					...
					int __temp_stmt148 = 0;
					{
						int p11 = this.pos++;
						{
							java.lang.String s13 = this.buf;
							__temp_stmt148 = ( (( p11 < s13.length() )) ? (((int) (s13.charAt(p11)) )) : (-1) );
						}
						
					}
					
					if (( __temp_stmt148 != 103 )) 
					{
