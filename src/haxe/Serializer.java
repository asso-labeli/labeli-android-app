...
public  class Serializer extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxe_Serializer(haxe.Serializer __temp_me13)
	{
		__temp_me13.buf = new haxe.root.StringBuf();
		__temp_me13.cache = new haxe.root.Array();
		__temp_me13.useCache = haxe.Serializer.USE_CACHE;
		__temp_me13.useEnumIndex = haxe.Serializer.USE_ENUM_INDEX;
		__temp_me13.shash = new haxe.ds.StringMap<java.lang.Object>();
		__temp_me13.scount = 0;
	}
			...
			switch (haxe.root.Type.enumIndex(_g))
			{
				...
				case 6:
				{
					java.lang.Class c = ((java.lang.Class) (_g.params.__get(0)) );
					{
						...
						{
							java.lang.Class __temp_switch113 = (c);
							if (haxe.lang.Runtime.eq(__temp_switch113, haxe.root.Array.class)) 
							{
								int ucount = 0;
								this.buf.add("a");
							...
							{
								if (haxe.lang.Runtime.eq(__temp_switch113, haxe.root.List.class)) 
								{
									this.buf.add("l");
									haxe.root.List v3 = ((haxe.root.List) (v) );
									{
										java.lang.Object __temp_iterator48 = v3.iterator();
										while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(__temp_iterator48, "hasNext", null)))
										{
											java.lang.Object i1 = ((java.lang.Object) (haxe.lang.Runtime.callField(__temp_iterator48, "next", null)) );
											this.serialize(i1);
										}
								...
								{
									if (haxe.lang.Runtime.eq(__temp_switch113, haxe.root.Date.class)) 
									{
									...
									{
										if (haxe.lang.Runtime.eq(__temp_switch113, haxe.ds.StringMap.class)) 
										{
											this.buf.add("b");
											haxe.ds.StringMap v4 = ((haxe.ds.StringMap) (v) );
											{
												java.lang.Object __temp_iterator49 = v4.keys();
												while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(__temp_iterator49, "hasNext", null)))
												{
													java.lang.String k = haxe.lang.Runtime.toString(haxe.lang.Runtime.callField(__temp_iterator49, "next", null));
										...
										{
											if (haxe.lang.Runtime.eq(__temp_switch113, haxe.ds.IntMap.class)) 
											{
												this.buf.add("q");
												haxe.ds.IntMap v5 = ((haxe.ds.IntMap) (v) );
												{
													java.lang.Object __temp_iterator50 = v5.keys();
													while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(__temp_iterator50, "hasNext", null)))
													{
														int k1 = ((int) (haxe.lang.Runtime.toInt(haxe.lang.Runtime.callField(__temp_iterator50, "next", null))) );
														this.buf.add(":");
														this.buf.add(k1);
											...
											{
												if (haxe.lang.Runtime.eq(__temp_switch113, haxe.ds.ObjectMap.class)) 
												{
													this.buf.add("M");
													haxe.ds.ObjectMap v6 = ((haxe.ds.ObjectMap) (v) );
													{
														java.lang.Object __temp_iterator51 = v6.keys();
														while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(__temp_iterator51, "hasNext", null)))
														{
															java.lang.Object k2 = ((java.lang.Object) (haxe.lang.Runtime.callField(__temp_iterator51, "next", null)) );
															this.serialize(k2);
												...
												{
													if (haxe.lang.Runtime.eq(__temp_switch113, haxe.io.Bytes.class)) 
													{
