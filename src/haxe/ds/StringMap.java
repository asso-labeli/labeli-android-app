...
public  class StringMap<T> extends haxe.lang.HxObject implements haxe.root.IMap<java.lang.String, T>
{
	...
	public static  <T_c> void __hx_ctor_haxe_ds_StringMap(haxe.ds.StringMap<T_c> __temp_me17)
	{
		__temp_me17.cachedIndex = -1;
	}
			 ...
			 else 
			{
				...
				do 
				{
					boolean __temp_stmt182 = false;
					{
						...
						__temp_stmt182 = ( (( v & -2 )) == 0 );
					}
					
					boolean __temp_boolv183 = false;
					if ( ! (__temp_stmt182) ) 
					{
						__temp_boolv183 = ( ( flag == k ) && haxe.lang.Runtime.valEq(this._keys[i], key) );
					}
	...
	public   int lookup(java.lang.String key)
	{
		if (( this.nBuckets != 0 )) 
		{
			...
			do 
			{
				boolean __temp_stmt187 = false;
				{
					int v = flag = hashes[i];
					__temp_stmt187 = ( v == 0 );
				}
				
				boolean __temp_boolv186 =  ! (__temp_stmt187) ;
				boolean __temp_boolv185 = false;
				if (__temp_boolv186) 
				{
					__temp_boolv185 = (( ( ( flag == 1 ) || ( flag != k1 ) ) ||  ! (haxe.lang.Runtime.valEq(keys[i], key))  ));
				}
				
				boolean __temp_stmt184 = ( __temp_boolv186 && __temp_boolv185 );
				if (__temp_stmt184) 
				{
					i = ( ( i +  ++ nProbes ) & mask );
				}
			...
			while ((  ++ j < nBuckets ))
			{
				...
				if ( ! (__temp_stmt188) ) 
				{
					...
					while (true)
					{
						...
						newHash[i] = k1;
						boolean __temp_boolv191 = ( i < nBuckets );
						boolean __temp_boolv190 = false;
						if (__temp_boolv191) 
						{
							boolean __temp_stmt192 = false;
							{
								int v2 = k1 = hashes[i];
								__temp_stmt192 = ( (( v2 & -2 )) == 0 );
							}
							
							__temp_boolv190 =  ! (__temp_stmt192) ;
						}
						
						boolean __temp_stmt189 = ( __temp_boolv191 && __temp_boolv190 );
						if (__temp_stmt189) 
						{
							{
	...
	public   java.lang.Object keys()
	{
		...
		{
			haxe.lang.Function __temp_odecl193 = new haxe.ds.StringMap_keys_356__Fun<T>(((haxe.root.Array<java.lang.Object>) (i) ), ((haxe.root.Array<haxe.ds.StringMap>) (_g1) ), ((haxe.root.Array<java.lang.Object>) (len) ));
			haxe.lang.Function __temp_odecl194 = new haxe.ds.StringMap_keys_367__Fun<T>(((haxe.root.Array<java.lang.Object>) (i) ), ((haxe.root.Array<haxe.ds.StringMap>) (_g1) ));
			return new haxe.lang.DynamicObject(new haxe.root.Array<java.lang.String>(new java.lang.String[]{"hasNext", "next"}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{__temp_odecl193, __temp_odecl194}), new haxe.root.Array<java.lang.String>(new java.lang.String[]{}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{}));
		}
