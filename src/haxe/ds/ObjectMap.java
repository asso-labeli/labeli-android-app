...
public  class ObjectMap<K, V> extends haxe.lang.HxObject implements haxe.root.IMap<K, V>
{
	...
	public static  <K_c, V_c> void __hx_ctor_haxe_ds_ObjectMap(haxe.ds.ObjectMap<K_c, V_c> __temp_me16)
	{
		__temp_me16.cachedIndex = -1;
	}
		...
		int[] hashes1 = hashes;
		{
			 ...
			 else 
			{
				...
				do 
				{
					...
					if ( ! (__temp_stmt163) ) 
					{
						__temp_boolv164 = ( ( flag == k ) && keys[i].equals(key) );
					}
	...
	public   int lookup(K key)
	{
		if (( this.nBuckets != 0 )) 
		{
			...
			do 
			{
				...
				if (__temp_boolv167) 
				{
					__temp_boolv166 = (( ( ( flag == 1 ) || ( flag != k1 ) ) ||  ! (keys[i].equals(key))  ));
				}
	...
	public   java.lang.Object keys()
	{
		...
		{
			haxe.lang.Function __temp_odecl174 = new haxe.ds.ObjectMap_keys_356__Fun<V, K>(((haxe.root.Array<java.lang.Object>) (len) ), ((haxe.root.Array<java.lang.Object>) (i) ), ((haxe.root.Array<haxe.ds.ObjectMap>) (_g1) ));
			haxe.lang.Function __temp_odecl175 = new haxe.ds.ObjectMap_keys_367__Fun<V, K>(((haxe.root.Array<java.lang.Object>) (i) ), ((haxe.root.Array<haxe.ds.ObjectMap>) (_g1) ));
