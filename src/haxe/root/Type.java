...
public  class Type extends haxe.lang.HxObject
{
	...
	public static   java.lang.String getClassName(java.lang.Class c)
	{
		...
		{
			java.lang.String __temp_svar89 = (name);
			...
			switch (__temp_hash91)
			{
				...
				{
					if (( (( ( __temp_hash91 == -672261858 ) && __temp_svar89.equals("Integer") )) || __temp_svar89.equals("int") )) 
					{
				...
				case -1939501217:
				{
					if (__temp_svar89.equals("Object")) 
					{
						__temp_executeDef90 = false;
						return "Dynamic";
					}
				...
				{
					if (( (( ( __temp_hash91 == 2052876273 ) && __temp_svar89.equals("Double") )) || __temp_svar89.equals("double") )) 
					{
						__temp_executeDef90 = false;
						return "Float";
					}
